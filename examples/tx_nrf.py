...
class tx_nrf(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.iio_pluto_sink_0 = iio.pluto_sink('ip:192.168.2.1', int(freq), int(samp_rate), 3000000, 0x200, False, 10.0, '', True)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.set_taps(firdes.low_pass(1.0, self.samp_rate, (self.symbol_rate/2)*1.5, 250e3, window.WIN_HAMMING, 6.76))
        self.iio_pluto_sink_0.set_params(int(self.freq), int(self.samp_rate), 3000000, 10.0, '', True)
